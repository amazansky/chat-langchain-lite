...
def _provider_unavailable(exc: Exception) -> str:
    """Degrade an exhausted-retry model failure into a short user-facing message."""
...
def _model_retry() -> ModelRetryMiddleware:
    ...
    # does not cover 403, and model.with_retry() cannot be used here because
    ...
    return ModelRetryMiddleware(max_retries=3, on_failure=_provider_unavailable)
