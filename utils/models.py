...
MODEL_CONFIG = {
    # CHAT_LANGCHAIN_LITE_MODEL lets scripts/setup.py swap the model for baseline
    # experiments; it must be applied here so the constructed model and the trace
    # metadata label (agent._config) stay in sync.
